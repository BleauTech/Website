"""
Django settings for bleautech project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'blog.context_processors.blog_post_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'bleautech.wsgi.application'
